 ...
 * @author gamunu
 */
public class FeedbackCell extends JTextPane implements TableCellRenderer {
    ...
    public Component getTableCellRendererComponent(JTable table, Object value,
        ...
        } else if (message.getHighlight().equals("Y")) {
            clr = Color.YELLOW;
        ...
        try {
            sc.insertString(0, message.getMessage(), keyWord);
        } catch (Exception e) {
